...
<li <?php if ($item['id'] == $this->currentItem || $item['id'] == $this->parentItem) {echo ' class="active"';}?>><a href="<?= $item['link'] ?>"><i class="fa <?= $item['icon'] ?>"></i><?= $item['name'] ?><?php if (isset($item['childs'])) : ?>
